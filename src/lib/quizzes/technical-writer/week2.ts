...
export const week2: Record<string, QuizQuestion[]> = {
  ...
  // Lesson 4: 贡献指南与写作规范 (12题，答案随机分布)
  "tw-w2-4": [
    {
      id: "tw-w2-4-q1",
      question: "根据 Keep a Changelog，变更日志（Changelog）的精确定义是什么？",
      options: [
        "Git 提交记录的自动导出",
        "'a curated, chronologically ordered list of notable changes for each version'——为人类编写的精选变更记录",
        "项目所有文件的修改历史",
        "CI/CD 管道的运行日志",
      ],
      answer: 1,
      rationale:
        "Keep a Changelog 强调 Changelog 是'curated'（精选的），面向人类读者，不同于机器生成的 Git commit log。",
    },
    {
      id: "tw-w2-4-q2",
      question: "Keep a Changelog 定义的六种变更类型分类是什么？",
      options: [
        "Added、Changed、Deprecated、Removed、Fixed、Security",
        "Create、Read、Update、Delete、List、Search",
        "Major、Minor、Patch、Alpha、Beta、RC",
        "Bug、Feature、Hotfix、Refactor、Test、Docs",
      ],
      answer: 0,
      rationale:
        "标准六分类：Added（新功能）、Changed（修改）、Deprecated（弃用预告）、Removed（已移除）、Fixed（修复）、Security（安全补丁）。",
    },
    {
      id: "tw-w2-4-q3",
      question: "GitHub 官方对 CONTRIBUTING 文件的核心价值描述是什么？",
      options: [
        "用于限制谁可以参与项目",
        "'help collaborators make meaningful, useful contributions'——帮助协作者做出有意义的贡献",
        "列出所有历史贡献者的名单",
        "记录项目的财务捐赠",
      ],
      answer: 1,
      rationale:
        "GitHub 文档明确指出 CONTRIBUTING 的目的是降低参与门槛，帮助贡献者做出有效贡献，而非设置障碍。",
    },
    {
      id: "tw-w2-4-q4",
      question: "为什么不应该直接使用 Git commit log 作为 Changelog？",
      options: [
        "Git log 格式不兼容 Markdown",
        "Git log 太吵杂且面向机器，Changelog 应该是为人类精选的重要变更",
        "Git 不支持导出 log",
        "Git log 会占用太多存储空间",
      ],
      answer: 1,
      rationale:
        "Keep a Changelog 明确警告：commit log 包含大量技术细节（如 merge commits），对用户不友好。Changelog 应该是精选的。",
    },
    {
      id: "tw-w2-4-q5",
      ...
      answer: 2,
      rationale:
        "ISO 8601（YYYY-MM-DD）是国际标准，避免 MM/DD/YYYY 和 DD/MM/YYYY 之间的地区歧义。",
    },
    {
      id: "tw-w2-4-q6",
      ...
      options: [
        "项目历史、团队成员、路线图",
        "如何开始（环境设置）、代码/文档规范、提交流程",
        "定价、支付方式、退款政策",
        "市场分析、竞争对手、商业模式",
      ],
      answer: 1,
      rationale:
        "CONTRIBUTING 的粒度要适中，太简单无指导作用，太复杂吓跑贡献者。核心覆盖：环境设置、规范、流程。",
    },
    {
      id: "tw-w2-4-q7",
      question: "GitHub 社区健康文件（Health Files）包括哪些核心文档？",
      options: [
        "只有 README.md",
        "Code of Conduct、Contributing Guidelines、License、Issue/PR Templates、Support Resources 等",
        "只有代码文件",
        "只有测试文件",
      ],
      answer: 1,
      rationale:
        "GitHub 定义了九大社区健康要素：行为准则、贡献指南、许可证、Issue/PR 模板、支持渠道、社区档案、健康文件、贡献标签等。",
    },
    {
      id: "tw-w2-4-q8",
      question: "Keep a Changelog 推荐在文件顶部维护什么部分？",
      options: [
        "[Deprecated] 部分",
        "[History] 部分",
        "[Unreleased] 部分——追踪待发布的变更",
        "[Future] 部分",
      ],
      answer: 2,
      rationale:
        "[Unreleased] 部分让用户了解即将发布的变化，也方便维护者在发布时直接移至新版本号下，减少遗漏。",
    },
    {
      id: "tw-w2-4-q9",
      question: "如何确保团队遵守贡献规范？",
      options: [
        "完全依赖人工审核",
        "只在文档中写明规范即可",
        "通过 CI 检查（linter、模板校验）和 PR 审查强制执行，规范必须可自动化验证",
        "定期发邮件提醒",
      ],
      answer: 2,
      rationale:
        "有规范但没人遵守等于没有。需要通过自动化检查（如 commitlint、markdownlint）和 PR 审查流程强制执行。",
    },
    {
      id: "tw-w2-4-q10",
      question: "Conventional Commits 规范的核心价值是什么？",
      options: [
        "让提交信息更长更详细",
        "使用 feat:/fix:/docs: 等前缀让提交历史结构化，支持自动生成 Changelog",
        "隐藏敏感的提交信息",
        "减少提交次数",
      ],
      answer: 1,
      rationale:
        "Conventional Commits 通过结构化前缀（feat、fix、docs、chore、refactor）让提交历史可机器解析，支持自动化工具生成 Changelog。",
    },
    {
      id: "tw-w2-4-q11",
      question: "Write the Docs 对建立文档文化的核心观点是什么？",
      options: [
        "文档是可选的附加产品",
        "'Quality documentation requires intentional processes, community collaboration'——需要刻意的流程设计和社区协作",
        "只需要 AI 自动生成文档",
        "文档应该由外包团队编写",
      ],
      answer: 1,
      rationale:
        "Write the Docs 强调文档不是副产品，需要刻意的流程设计（如 Docs as Code）和社区协作才能保持高质量。",
    },
    {
      id: "tw-w2-4-q12",
      question: "Issue 和 PR 模板的核心价值是什么？",
      options: [
        "增加贡献者的工作量",
        "让项目看起来更专业",
        "引导贡献者提供必要信息，减少'信息不足'的来回沟通",
        "限制贡献者只能报告特定类型的问题",
      ],
      answer: 2,
      rationale:
        "模板通过预设字段和检查清单，引导贡献者提供复现步骤、环境信息、预期行为等必要内容，提高沟通效率。",
    },
  ],
};
