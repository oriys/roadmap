...
export const week1: Record<string, QuizQuestion[]> = {
  ...
  // Lesson 4: 清晰表达与风格指南 (12题，答案随机分布)
  "tw-w1-4": [
    {
      id: "tw-w1-4-q1",
      question: "Google Style Guide 的核心原则'Break any of these rules sooner than say anything outright barbarous'意味着什么？",
      options: [
        "规则可以随意打破",
        "清晰性和可读性优先于严格遵循规则",
        "规则只是建议",
      ...
      answer: 1,
      rationale:
        "Google 明确：当规则与可读性冲突时，选择可读性。规则服务于清晰性，而非相反。",
    },
    {
      id: "tw-w1-4-q2",
      question: "Microsoft 现代声调的三个要素是什么？",
      options: [
        "Warm and relaxed, Crisp and clear, Ready to lend a hand",
        "Professional, Technical, Precise",
        "Simple, Short, Standard",
        "Formal, Accurate, Complete",
      ],
      answer: 0,
      rationale:
        "Microsoft Style Guide 的三要素：温暖放松、简洁清晰、乐于助人——塑造技术写作的人性化方向。",
    },
    {
      id: "tw-w1-4-q3",
      question: "风格指南的认知价值主要体现在什么方面？",
      options: [
        "让文档看起来更专业",
        "一致的语调和风格减少用户的认知负荷，用户不必适应不同的表达方式",
        "便于翻译",
        "减少作者的写作时间",
      ],
      answer: 1,
      rationale:
        "Write the Docs: 风格指南不是美学问题，而是效率问题——一致性减少用户的认知负担。",
    },
    {
      id: "tw-w1-4-q4",
      question: "主动语态为什么是技术写作的默认选择？",
      options: [
        "语法规范要求",
        "翻译成本更低",
        "明确'谁做了什么'，减少解析负担，信息密度更高",
        "被动语态是错误的",
      ],
      answer: 2,
      rationale:
        "'The system deletes the file' 比 'The file is deleted by the system' 更直接——主动语态明确行动者和动作的关系。",
    },
    {
      id: "tw-w1-4-q5",
      question: "被动语态在哪些场景下仍然有用？",
      options: [
        "任何时候都应避免",
        "强调结果而非行动者、行动者未知或不重要、避免指责时",
        "只在法律文档中使用",
        "只在学术论文中使用",
      ],
      answer: 1,
      rationale:
        "被动语态有特定用途：强调结果、隐藏行动者、避免指责。关键是有意识地选择。",
    },
    {
      id: "tw-w1-4-q6",
      question: "术语不一致（如混用 click/tap/select）会导致什么问题？",
      options: [
        "只是风格不统一",
        "用户会怀疑是否在说同一件事，增加理解成本",
        "影响 SEO 排名",
        "增加翻译难度",
      ],
      answer: 1,
      rationale:
        "术语不一致会让用户困惑：这两个词是同一个意思，还是有细微差别？建立术语表并强制执行。",
    },
    {
      id: "tw-w1-4-q7",
      question: "如何识别文档中的'行话陷阱'？",
      options: [
        "使用专业术语检测工具",
        "让不熟悉项目的人阅读文档，让他们标记所有不理解的词",
        "检查术语是否出现在词典中",
        "统计专业术语的使用频率",
      ],
      answer: 1,
      rationale:
        "最有效的方法：让目标用户（或模拟用户）标记所有不理解的术语——这些就是你的行话盲区。",
    },
    {
      id: "tw-w1-4-q8",
      question: "打破'文字墙'的有效技术包括哪些？",
      options: [
        "只使用更短的词",
        "每段只讲一件事、用列表替代连续的'和'、用表格替代重复模式、用代码块隔离命令",
        "删除所有解释性内容",
        "增加更多图片",
      ],
      answer: 1,
      rationale:
        "视觉层级技术：拆分段落、列表化、表格化、代码块隔离——目标是提高可扫描性（Scannability）。",
    },
    {
      id: "tw-w1-4-q9",
      question: "风格指南的参考等级层次是什么？",
      options: [
        "项目特定指南 > Google/Microsoft Style Guide > Chicago Manual > Merriam-Webster",
        "Google Style Guide 始终优先",
        "最新发布的指南优先",
        "字数最少的规则优先",
      ],
      answer: 0,
      rationale:
        "项目特定指南最优先（针对性最强），然后是行业标准（Google/Microsoft），最后是通用参考（Chicago/词典）。",
    },
    {
      id: "tw-w1-4-q10",
      question: "首字母缩写词（Acronyms）的正确处理方式是什么？",
      options: [
        "始终只使用缩写以节省空间",
        "假设读者都知道常见缩写",
      ...
      answer: 2,
      rationale:
        "首次使用时给出全称，后续可只用缩写。不要假设读者知道任何缩写的含义。",
    },
    {
      id: "tw-w1-4-q11",
      question: "为什么 Microsoft 建议用'Select'替代'Click'？",
      options: [
        "'Click'听起来不专业",
      ...
      answer: 1,
      rationale:
        "Microsoft: 使用设备无关的术语，让文档适用于所有用户，不论他们使用什么输入方式。",
    },
    {
      id: "tw-w1-4-q12",
      question: "Global English（全球英语）写作为什么要避免成语和文化隐喻？",
      options: [
        "成语会增加文档长度",
        "成语难以翻译且可能造成误解，如'a piece of cake'对非母语读者毫无意义",
        "成语是非正式表达",
        "成语会降低文档的专业性",
      ],
      answer: 1,
      rationale:
        "Google: 成语和文化隐喻（如'kosher'、'sticky wicket'）对非母语读者毫无意义，翻译软件也难以处理。",
    },
  ],
};
