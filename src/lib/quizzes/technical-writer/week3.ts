...
export const week3: Record<string, QuizQuestion[]> = {
  ...
  // Lesson 4: 图表与示意图（可维护）(12题，答案随机分布)
  "tw-w3-4": [
    {
      id: "tw-w3-4-q1",
      question: "Mermaid 在 2019 年获得了什么奖项？",
      options: [
        "最佳开源项目奖",
        "JavaScript Open Source Award '最令人兴奋的技术应用'",
        "最佳文档工具奖",
        "最佳可视化工具奖",
      ],
      answer: 1,
      rationale:
        "Mermaid 获得了 2019 年 JavaScript Open Source Award for 'The Most Exciting Use of Technology'。",
    },
    {
      id: "tw-w3-4-q2",
      question: "Mermaid 的核心特性是什么？",
      options: [
        "将'Markdown-inspired text definitions'转换为动态图表",
        "提供拖拽式图形编辑界面",
        "只支持静态图片导出",
        "需要专业设计软件配合使用",
      ],
      answer: 0,
      rationale:
        "Mermaid 是 JavaScript 工具，converts 'Markdown-inspired text definitions to create and modify diagrams dynamically'。",
    },
    {
      id: "tw-w3-4-q3",
      question: "PlantUML 的核心定位是什么？",
      options: [
        "专业的图形设计软件",
        "只支持流程图的工具",
        "'通过简单的文本描述来绘制精美的 UML 图表'的开源工具",
        "仅用于 Web 开发的可视化工具",
      ],
      answer: 2,
      rationale:
        "PlantUML 是开源工具，'通过简单的文本描述来绘制精美的 UML 图表'——降低图表创建的技术门槛。",
    },
    {
      id: "tw-w3-4-q4",
      question: "Mermaid 支持多少种图表类型？",
      options: [
        "只有 5 种基本类型",
        "10 种标准 UML 图",
        "25+ 种，包括流程图、时序图、类图、甘特图、Git Graph、C4 架构图等",
        "不限数量，完全自定义",
      ],
      answer: 2,
      rationale:
        "Mermaid 支持 25+ 种图表类型：流程图、时序图、类图、状态图、Git Graph、甘特图、ER 图、C4、思维导图、Kanban 等。",
    },
    {
      id: "tw-w3-4-q5",
      question: "文本格式图表（Mermaid/PlantUML）相比二进制图片的核心优势是什么？",
      options: [
        "文件体积更小",
        "渲染速度更快",
        "可以纳入 Git 仓库、版本控制、通过 PR 进行代码审查",
        "支持更多颜色选项",
      ],
      answer: 2,
      rationale:
        "文本格式的图表可以像代码一样进行 diff、review、版本控制——这是二进制图片文件无法实现的。",
    },
    {
      id: "tw-w3-4-q6",
      question: "Diátaxis 框架中 Explanation 文档的特点是什么？",
      options: [
        "只关注操作步骤",
        "提供即时参考查询",
        "'深化和拓展读者对主题的理解，带来 clarity、光线和背景'",
        "仅用于 API 参考",
      ],
      answer: 2,
      rationale:
        "Diátaxis：Explanation 文档'深化和拓展读者对主题的理解，带来 clarity、光线和背景'——图表帮助建立连接。",
    },
    {
      id: "tw-w3-4-q7",
      question: "时序图（Sequence Diagram）最适合展示什么？",
      options: [
        "数据的统计分布",
        "多个组件之间的交互顺序和消息传递",
        "项目的进度安排",
      ...
      answer: 1,
      rationale:
        "时序图展示参与者之间按时间顺序的交互过程，如 API 请求处理流程：Client → Gateway → Service → Database。",
    },
    {
      id: "tw-w3-4-q8",
      question: "图表的可访问性要求是什么？",
      options: [
        "图表必须使用高对比度颜色",
        "图表需要配合文字说明和 alt 文本，不看图也应能理解核心要点",
        "图表必须支持放大缩小",
        "图表必须提供打印版本",
      ],
      answer: 1,
      rationale:
        "视觉障碍用户依赖 alt 文本或等效的文字描述。图表应配合文字说明，确保不看图也能理解核心信息。",
    },
    {
      id: "tw-w3-4-q9",
      question: "选择图表类型时的核心问题是什么？",
      options: [
        "'读者需要理解什么？'——聚焦核心概念，省略不必要细节",
        "哪种类型最美观？",
        "哪种类型最流行？",
        "哪种类型支持最多功能？",
      ],
      answer: 0,
      rationale:
        "图表应简化复杂性而非展示所有细节。关键问题：'读者需要理解什么？'选错类型会让读者更困惑。",
    },
    {
      id: "tw-w3-4-q10",
      question: "PlantUML 支持哪些类型的图表？",
      options: [
        "只支持流程图",
        "9 种标准 UML 图 + 多种非 UML 图（JSON/YAML、Gantt、思维导图等）",
        "只支持类图和时序图",
        "只支持非 UML 图表",
      ],
      answer: 1,
      rationale:
        "PlantUML 支持 9 种标准 UML 图（序列图、用例图、类图等）和多种非 UML 图（Gantt、思维导图、网络图等）。",
    },
    {
      id: "tw-w3-4-q11",
      question: "在 GitHub 中嵌入 Mermaid 图表的方式是什么？",
      options: [
        "上传 PNG 图片文件",
        "使用 ```mermaid 代码块",
        "使用 HTML img 标签",
      ...
      answer: 1,
      rationale:
        "GitHub 原生支持 Mermaid——使用 ```mermaid 代码块即可在 README 和 Issue 中渲染图表。",
    },
    {
      id: "tw-w3-4-q12",
      question: "C4 Model 是什么？",
      options: [
        "一种编程语言",
        "软件架构可视化方法：Context → Container → Component → Code 四层抽象",
        "一种图表格式",
        "一种文档模板",
      ],
      answer: 1,
      rationale:
        "C4 Model 是软件架构可视化方法，从 Context（上下文）到 Code（代码）分四层抽象描述系统架构。Mermaid 支持 C4 图表。",
    },
  ],
};
