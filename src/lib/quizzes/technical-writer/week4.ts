...
export const week4: Record<string, QuizQuestion[]> = {
  ...
  // Lesson 4: CLI 文档与命令参考 (12题，答案随机分布)
  "tw-w4-4": [
    {
      id: "tw-w4-4-q1",
      ...
      answer: 1,
      rationale:
        "GNU 命令行标准：短选项用单破折号（-v）、长选项用双破折号（--verbose），这是 Unix/Linux 命令的事实标准。",
    },
    {
      id: "tw-w4-4-q2",
      question: "Cobra CLI 框架被多少个项目使用？",
      options: [
        "1,000+ 项目",
        "10,000+ 项目",
        "173,000+ 项目，包括 Kubernetes、Docker、GitHub CLI",
        "500 个项目",
      ],
      answer: 2,
      rationale:
        "Cobra 是 Go 语言 CLI 框架，被 173,000+ 项目使用，包括 Kubernetes、Docker、GitHub CLI 等知名项目。",
    },
    {
      id: "tw-w4-4-q3",
      ...
      options: [
        "与在线文档完全相同，越详细越好",
        "简洁、可扫描，在终端中快速查阅，详细说明链接到在线文档",
        "只显示版本号即可",
        "只列出命令名称",
      ],
      answer: 1,
      rationale:
        "--help 面向正在工作中的用户，需要快速查阅。应简洁列出关键信息（Usage、Description、Options），详细说明链接到在线文档。",
    },
    {
      id: "tw-w4-4-q4",
      question: "Click 框架的核心特点是什么？",
      options: [
        "只支持简单的命令行工具",
        "需要大量样板代码",
        "'创建美观的命令行界面，代码量最少'，支持命令嵌套和自动帮助生成",
        "只能用于 Go 语言",
      ],
      answer: 2,
      rationale:
        "Click 是 Python CLI 框架，特点是'创建美观的命令行界面，代码量最少'，支持命令嵌套、自动帮助生成、动态加载子命令。",
    },
    {
      id: "tw-w4-4-q5",
      question: "CLI 命令的退出码（Exit Code）在脚本中的重要性是什么？",
      options: [
        "只是技术细节，用户不需要知道",
      ...
      answer: 1,
      rationale:
        "退出码对自动化至关重要——用户需要知道哪些退出码表示成功（0）、哪些表示特定错误类型（非 0），以便在脚本中判断执行结果。",
    },
    {
      id: "tw-w4-4-q6",
      question: "Cobra 框架支持哪些 shell 的自动补全？",
      options: [
        "只支持 Bash",
        "只支持 Zsh",
      ...
      answer: 2,
      rationale:
        "Cobra 支持多种 shell 的自动补全：Bash、Zsh、Fish 和 PowerShell，帮助用户快速输入命令和选项。",
    },
    {
      id: "tw-w4-4-q7",
      question: "CLI 文档的层次结构应该包含哪些部分？",
      options: [
        "只需要命令列表",
        "快速参考（常用命令速查）、完整参考（所有命令和选项）、教程（常见任务的步骤）",
        "只需要安装说明",
        "只需要 FAQ",
      ],
      answer: 1,
      rationale:
        "CLI 文档层次：快速参考（常用命令速查）、完整参考（所有命令和选项）、教程（常见任务的步骤）——不同用户需要不同层次的文档。",
    },
    {
      id: "tw-w4-4-q8",
      question: "在 CLI 文档中，如何表示可选参数？",
      options: [
        "用括号 () 表示",
        "用尖括号 <> 表示",
        "用方括号 [] 表示可选",
      ...
      answer: 2,
      rationale:
        "CLI 文档约定：必需参数不加括号或用尖括号 <>，可选参数用方括号 [] 表示，这是命令行帮助信息的通用格式。",
    },
    {
      id: "tw-w4-4-q9",
      question: "CLI 配置的优先级规则通常是什么？",
      options: [
        "配置文件 > 环境变量 > 命令行",
        "环境变量 > 命令行 > 配置文件",
        "命令行 > 环境变量 > 配置文件",
      ...
      answer: 2,
      rationale:
        "CLI 配置优先级通常是：命令行 > 环境变量 > 配置文件——命令行参数最具体，优先级最高。",
    },
    {
      id: "tw-w4-4-q10",
      question: "Cobra 框架可以自动生成哪些文档格式？",
      options: [
        "只能生成纯文本",
        "man page 和 Markdown 文档",
        "只能生成 HTML",
        "不支持文档生成",
      ],
      answer: 1,
      rationale:
        "Cobra 支持自动生成 man page 和 Markdown 文档，减少手动编写文档的工作量。",
    },
    {
      id: "tw-w4-4-q11",
      question: "Click 框架的帮助信息是如何生成的？",
      options: [
        "需要手动编写所有帮助文本",
        "由装饰器和 docstring 自动提取生成",
        "需要单独的配置文件",
        "只能显示默认信息",
      ],
      answer: 1,
      rationale:
        "Click 的帮助信息由装饰器和文档字符串（docstring）自动提取生成，无需手动编写，包含 Usage、Description、Options 等部分。",
    },
    {
      id: "tw-w4-4-q12",
      question: "CLI 命令参考文档应该包含哪些核心信息？",
      options: [
        "只需要命令名称",
        "只需要一个示例",
      ...
      answer: 2,
      rationale:
        "完整的命令参考需要：命令用途、语法、参数说明（类型、是否必需、默认值）、示例、返回值/退出码——让用户清楚知道如何使用和判断结果。",
    },
  ],
};
