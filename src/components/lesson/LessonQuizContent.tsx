...
export type LessonQuizView = { lesson: Lesson; week: Week; stage: Stage }

type LessonQuizContentProps = {
  view: LessonQuizView
    ...
    <div className="space-y-4">
      {showHeader && (
        <div className="mb-6">
          ...
          <p className="text-sm text-muted-foreground mt-2">{getLessonOverview(view.lesson) || view.lesson.detail}</p>
        </div>
      )}
